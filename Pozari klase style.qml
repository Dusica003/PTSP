...
<qgis maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" classificationMax="4" nodataColor="" opacity="1" alphaBand="-1" type="singlebandpseudocolor" classificationMin="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" minimumValue="1" maximumValue="4" classificationMode="2" labelPrecision="6" clip="0">
          ...
          <item value="1" alpha="255" color="#04d23e" label="1"/>
          <item value="2" alpha="255" color="#fff645" label="2"/>
          <item value="3" alpha="255" color="#ff9429" label="3"/>
          <item value="4" alpha="255" color="#ff0d01" label="4"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
