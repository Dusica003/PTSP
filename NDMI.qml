...
<qgis maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" classificationMax="0.6" nodataColor="" opacity="1" alphaBand="-1" type="singlebandpseudocolor" classificationMin="-0.6">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" minimumValue="-0.6" maximumValue="0.6" classificationMode="1" labelPrecision="4" clip="0">
          ...
          <item value="-0.6" alpha="255" color="#d7191c" label="-0.6000"/>
          <item value="-0.3" alpha="255" color="#fdae61" label="-0.3000"/>
          <item value="0" alpha="255" color="#ffffbf" label="0.0000"/>
          <item value="0.3" alpha="255" color="#abdda4" label="0.3000"/>
          <item value="0.6" alpha="255" color="#2b83ba" label="0.6000"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
